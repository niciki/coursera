...
std::unordered_map<std::string, Coordinates>& RouteManager::GetStopCoordinates() {
    return stop_coordinates;
}

std::unordered_map<std::string, std::unordered_map<std::string, int>>& RouteManager::GetStopDistances() {
    return stop_distances;
}

std::unordered_map<std::string, std::set<std::string>>& RouteManager::GetStopBuses() {
    return stop_buses;
}

std::unordered_map<std::string, RouteStatistic>& RouteManager::GetRouteStatistics() {
