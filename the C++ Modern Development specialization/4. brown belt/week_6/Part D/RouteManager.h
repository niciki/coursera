...
public:
    ...
    void Print() const;
    std::unordered_map<std::string, Coordinates>& GetStopCoordinates();
    std::unordered_map<std::string, std::unordered_map<std::string, int>>& GetStopDistances();
    std::unordered_map<std::string, std::set<std::string>>& GetStopBuses();
    std::unordered_map<std::string, RouteStatistic>& GetRouteStatistics();
