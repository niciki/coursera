...
public:
    ...
    const geo2d::Point& Get_data() const;
private:
    geo2d::Point pos;
};
...
public:
    ...
    bool CollideWith(const Tower& that) const override;
    bool CollideWith(const Fence& that) const override;
    const geo2d::Rectangle& Get_data() const;
private:
    geo2d::Rectangle rec;
};
...
public:
    explicit Tower(geo2d::Circle geometry): cir(geometry) {}
    bool Collide(const GameObject& that) const override;
    bool CollideWith(const Unit& that) const override;
    bool CollideWith(const Building& that) const override;
    bool CollideWith(const Tower& that) const override;
    bool CollideWith(const Fence& that) const override;
    const geo2d::Circle& Get_data() const;
private:
    geo2d::Circle cir;
};
...
public:
    ...
    bool CollideWith(const Tower& that) const override;
    bool CollideWith(const Fence& that) const override;
    const geo2d::Segment& Get_data() const;
private:
    geo2d::Segment seg;
};
...
bool Unit::CollideWith(const Unit& that) const {
    return geo2d::Collide(this->Get_data(), that.Get_data());
}
...
const geo2d::Point& Unit::Get_data() const {
    return pos;
}
...
const geo2d::Rectangle& Building::Get_data() const {
    return rec;
}
...
const geo2d::Circle& Tower::Get_data() const {
    return cir;
}
...
const geo2d::Segment& Fence::Get_data() const {
    return seg;
}
