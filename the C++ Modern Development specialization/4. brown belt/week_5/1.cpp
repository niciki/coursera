...
void PrintStats(vector<Person> persons) {
    ...
    it = partition(persons.begin(), persons.end(), [](const Person& p){
        return p.gender == Gender::MALE;
    });
    cout << "Median age for males = " << ComputeMedianAge(persons.begin(), it) << "\n";
    it = partition(persons.begin(), persons.end(), [](const Person& p){
        return p.gender == Gender::FEMALE && p.is_employed;
    });
    cout << "Median age for employed females = " << ComputeMedianAge(persons.begin(), it) << "\n";
    it = partition(persons.begin(), persons.end(), [](const Person& p){
        return p.gender == Gender::FEMALE && !p.is_employed;
    });
    cout << "Median age for unemployed females = " << ComputeMedianAge(persons.begin(), it) << "\n";
    it = partition(persons.begin(), persons.end(), [](const Person& p){
        return p.gender == Gender::MALE && p.is_employed;
    });
    cout << "Median age for employed males = " << ComputeMedianAge(persons.begin(), it) << "\n";
    it = partition(persons.begin(), persons.end(), [](const Person& p){
        return p.gender == Gender::MALE && !p.is_employed;
    });
