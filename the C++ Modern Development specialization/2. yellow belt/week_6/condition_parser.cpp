...
// parsing of comparison e.g. Find date >= 2017-01-01
...
// parse of logical expressions e.g date >= 2017-01-01 AND date < 2017-07-01 AND event == "sport event"
...
// Parse all condition as parsing expressions
